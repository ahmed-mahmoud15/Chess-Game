...
public abstract class ChessGame {
    ...
    protected ChessGame(ChessGame game) {
        ...
        this.canBlackCastleKingSide = game.isCanBlackCastleKingSide();
        this.canBlackCastleQueenSide = game.isCanBlackCastleQueenSide();
        this.canWhiteCastleKingSide = game.isCanWhiteCastleKingSide();
        this.canWhiteCastleQueenSide = game.isCanWhiteCastleQueenSide();
    }
    
    @Override
    public abstract ChessGame clone();
